...
AppPublisher=BatikCode
AppPublisherURL=https://github.com/99apps-id/batikcode
AppSupportURL=https://github.com/99apps-id/batikcode/issues
AppUpdatesURL=https://github.com/99apps-id/batikcode/releases
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=BatikCodeSetup
Compression=lzma
