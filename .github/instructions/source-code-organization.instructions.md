---
description: BatikCode source code organization — layers, target environments, dependency injection, and folder structure conventions. Reference when adding new modules, services, or contributions.
applyTo: src/vs/**
---
...
4. **`workbench`** — Full BatikCode workbench, panels, views, and framework
