...
If the user needs the agent to launch BatikCode, drive a scenario, and capture snapshots first, use the BatikCode performance workflow skill before returning here for low-level snapshot analysis.
...
### Common BatikCode Retention Patterns
