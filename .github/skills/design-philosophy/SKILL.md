...
description: The BatikCode design philosophy — a shared Values→Principles→Moves vocabulary for reasoning about UI in design terms instead of raw pixels. Use when designing, building, reviewing, or giving feedback on any visual surface; when deciding a radius, spacing, type role, icon size, border, color, or motion; or when translating a "this feels off" observation into a concrete, principled fix.
---

# BatikCode Design Philosophy

This skill is the **canonical BatikCode design philosophy** — the single source of
...
These four values name what we want people to *feel* using BatikCode - they're the
...
the values BatikCode is structurally inclined to *lose*:

- **Calm** is the first casualty of an IDE. BatikCode is information-dense and lived
...
- **Consistent** has the largest surface area to defend. BatikCode is built by many
