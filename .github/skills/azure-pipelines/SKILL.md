...
description: Use when validating Azure DevOps pipeline changes for the BatikCode build. Covers queueing builds, checking build status, viewing logs, and iterating on pipeline YAML changes without waiting for full CI runs.
---
