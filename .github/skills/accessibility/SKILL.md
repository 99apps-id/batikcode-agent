---
name: accessibility
description: Primary accessibility skill for BatikCode. REQUIRED for new feature and contribution work, and also applies to updates of existing UI. Covers accessibility help dialogs, accessible views, verbosity settings, signals, ARIA announcements, keyboard navigation, and ARIA labels/roles.
---

## When to Use This Skill

Use this skill for any BatikCode feature work that introduces or changes interactive UI.
...
When adding a **new interactive UI surface** to BatikCode — a panel, view, widget, editor overlay, dialog, or any rich focusable component the user interacts with — you **must** provide three accessibility components (if they do not already exist for the feature):
...
- **Focus visibility**: Focused elements must have a visible focus indicator (BatikCode's theme system provides this via `focusBorder`).
