...
description: Find duplicates for a BatikCode GitHub issue
...
2. Follow those instructions PRECISELY to identify potential duplicate issues for a given issue number in the BatikCode repository.
