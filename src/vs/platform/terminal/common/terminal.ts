...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit BatikCode's "shell environment" that may
	 ...
	 * a terminal used to drive some BatikCode feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to BatikCode and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** BatikCode shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
