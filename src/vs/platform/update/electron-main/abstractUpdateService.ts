...
export type UpdateErrorClassification = {
	...
	comment: 'This is used to know how often BatikCode updates have failed.';
};
...
export abstract class AbstractUpdateService extends Disposable implements IUpdateService {
	...
	private async trackVersionChange(): Promise<void> {
		...
		type VersionChangeClassification = {
			owner: 'dmitriv';
			comment: 'Fired when BatikCode detects a version change on startup.';
			fromVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The previous version of BatikCode.' };
			...
			toVersion: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; comment: 'The current version of BatikCode.' };
