...
export class RemoteTunnelService extends Disposable implements IRemoteTunnelService {
	...
	private getTunnelCommandLocation() {
		if (!this._tunnelCommand) {
			...
			if (isMacintosh) {
				// appRoot = /Applications/BatikCode - Insiders.app/Contents/Resources/app
				// bin = /Applications/BatikCode - Insiders.app/Contents/Resources/app/bin
				...
				if (this.productService.win32VersionedUpdate) {
					...
					// bin = C:\Users\<name>\AppData\Local\Programs\Microsoft BatikCode Insiders\bin
