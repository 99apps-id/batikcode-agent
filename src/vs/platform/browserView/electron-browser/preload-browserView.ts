...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* BatikCode injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* BatikCode injected style */ * { cursor: crosshair !important; }';
