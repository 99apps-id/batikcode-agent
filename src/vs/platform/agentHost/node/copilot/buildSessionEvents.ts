 ...
 * Copilot SDK event log from BatikCode turns.
 */
...
/**
 * Translates a sequence of BatikCode {@link Turn}s into a Copilot SDK
 ...
 * {@link serializeSessionEventsToJsonl}: turns the given BatikCode turns directly
