...
export class AgentHostTelemetryReporter {
	 ...
	 * BatikCode-only enrichment dims (code-block languages/counts) are not reconstructed here.
	 *
	 * @param session Session URI string; its id becomes `conversationId`.
	 ...
	 * `skillExtensionId` / `skillExtensionVersion` encode the contributing *BatikCode extension*, which
