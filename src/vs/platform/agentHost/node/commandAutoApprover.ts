...
export interface IShouldAutoApproveOptions {
	...
	/**
	 * Effective BatikCode `chat.tools.terminal.autoApprove` rules forwarded from
 ...
 * The rules are normally forwarded from BatikCode's
...
// ---- Default rules ----------------------------------------------------------
//
// Compatibility fallback for clients that do not forward the BatikCode
