...
export class AgentHostStateManager extends Disposable {
	 ...
	 * onto a per-chat channel. BatikCode currently models every session as
	 ...
	 * the session's single chat. BatikCode models every session as having
	 ...
	 * dispatching this action; for BatikCode-internal clients that happens
	 ...
	 * activity status) onto the chat channel. To preserve BatikCode's
