	...
	suite('tool_ready dispatches progress actions to advance tool call state', () => {
		...
		test('tool_ready is dropped when the tool completes while permission lookup is pending', async () => {
			...
			agent.fireProgress({
				...
				action: {
					type: ActionType.ChatToolCallStart, turnId: 'turn-1',
					toolCallId: 'tc-stale-ready', toolName: 'vscodeAPI', displayName: 'Get BatikCode API References',
			...
			agent.fireProgress({
				...
				state: {
					status: ToolCallStatus.PendingConfirmation,
					toolCallId: 'tc-stale-ready', toolName: 'vscodeAPI', displayName: 'Get BatikCode API References',
					invocationMessage: 'Get BatikCode API References', toolInput: '{"query":"test"}',
			...
			stateManager.dispatchServerAction(defaultChatUri, {
				...
				invocationMessage: 'Get BatikCode API References',
				confirmed: ToolCallConfirmationReason.NotNeeded,
			});
			stateManager.dispatchServerAction(defaultChatUri, {
				...
				result: {
					success: false,
					pastTenseMessage: 'Get BatikCode API References failed',
