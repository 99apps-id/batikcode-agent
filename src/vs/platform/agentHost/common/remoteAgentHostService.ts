...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a BatikCode CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * BatikCode Remote SSH authority.
	 */
	 ...
	 * client connects to, and is used to construct the BatikCode Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the BatikCode Remote Tunnels authority
