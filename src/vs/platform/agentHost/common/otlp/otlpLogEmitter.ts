...
/**
 * Map a BatikCode {@link LogLevel} onto the corresponding OTLP
...
/**
 * Map a BatikCode {@link LogLevel} onto the matching OTLP level name used in
...
/**
 * Reverse of {@link logLevelToOtlpSeverity}: returns the closest BatikCode
