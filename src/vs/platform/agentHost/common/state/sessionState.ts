...
// (synced from the agent-host-protocol repo). This file adds BatikCode-specific
...
// ---- BatikCode-specific derived types -----------------------------------------
...
/**
 * BatikCode-side alias for the protocol's open `_meta` property bag on
 ...
 * {@link ISessionGitState}. This is a BatikCode-specific convention layered
 ...
 * payload. Value at this key, when present, MUST be shaped like
 * {@link ISessionGitHubState}. This is a BatikCode-specific convention layered
 * on top of the protocol's generic `_meta` bag — the protocol itself does
 ...
 * session). Used to bound recursive session creation. BatikCode-specific convention
 ...
 * full session state. BatikCode-specific convention layered on the protocol's
 * generic `_meta` bag.
 */
 ...
 * This is a BatikCode-specific convention layered on top of the protocol's
 * generic `_meta` bag — the protocol itself does not know about build info.
 */
export const ROOT_META_HOST_BUILD_KEY = 'hostBuild';

/**
 * Build information about the program hosting the agent host (the BatikCode CLI),
