...
// This file adds BatikCode-specific additions (ISetAuthTokenParams, ProtocolError)
...
/**
 * BatikCode-specific extension: set the auth token on the server.
