 ...
 * by the BatikCode CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the BatikCode CLI populate this
 ...
 * extension used by BatikCode-hosted agent hosts.
 *
