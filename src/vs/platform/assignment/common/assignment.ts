...
export enum Filters {
	...
	/**
	 * The language in use by BatikCode
	 */
	...
	/**
	 * The platform (OS) on which BatikCode is running.
	 */
	Platform = 'X-VSCode-Platform',

	/**
	 * The release/build date of BatikCode (UTC) in the format yyyymmddHH.
	 */
	ReleaseDate = 'X-VSCode-ReleaseDate',

	/**
	 * The kind of window BatikCode is running in (`editor` or `agents`).
	 */
