...
/**
 * Renders the "Open in BatikCode" titlebar entry as an icon-only button that
...
export class OpenInVSCodeTitleBarWidget extends BaseActionViewItem {
	...
	override render(container: HTMLElement): void {
		...
		const hoverText = this.keybindingService.appendKeybinding(localize('openInVSCodeHover', "Open in BatikCode Editor Window"), this.keybindingCommandId);
