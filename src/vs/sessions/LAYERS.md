...
The sessions layer sits above `vs/workbench` in the BatikCode source code hierarchy. For the broader BatikCode layer rules (base → platform → editor → workbench → sessions), see `.github/instructions/source-code-organization.instructions.md`.
