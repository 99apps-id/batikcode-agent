...
/**
 * BatikCode logo "fish" used by the Agents window aquarium. Each fish is a small
...
/** The three BatikCode release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the BatikCode logo path. All fish reference
 ...
 *   - BatikCode logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original BatikCode icon.
