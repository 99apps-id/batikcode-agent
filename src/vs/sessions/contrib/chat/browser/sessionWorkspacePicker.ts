...
export class WorkspacePicker extends Disposable {
	...
	/** Cached BatikCode recent folder URIs, resolved lazily. */
	...
	constructor(
		...
		// Load BatikCode recent folders eagerly and refresh on changes
	 ...
	 * without source grouping. Own recents come first, followed by BatikCode
	 * recent folders.
	 */
	protected _buildItems(): IActionListItem<IWorkspacePickerItem>[] {
		...
		// Merge BatikCode recent folders (resolved through providers, deduplicated)
	...
	/**
	 * Returns BatikCode recent folders resolved through registered session
