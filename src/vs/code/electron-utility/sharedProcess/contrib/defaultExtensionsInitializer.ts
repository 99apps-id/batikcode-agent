...
export class DefaultExtensionsInitializer extends Disposable {
	...
	private getDefaultExtensionVSIXsLocation(): URI {
		if (this.productService.win32VersionedUpdate) {
			// appRoot = C:\Users\<name>\AppData\Local\Programs\Microsoft BatikCode Insiders\<version>\resources\app
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft BatikCode Insiders\<version>\bootstrap\extensions
			return URI.file(join(dirname(dirname(dirname(this.environmentService.appRoot))), 'bootstrap', 'extensions'));
		} else {
			// appRoot = C:\Users\<name>\AppData\Local\Programs\Microsoft BatikCode Insiders\resources\app
			// extensionsPath = C:\Users\<name>\AppData\Local\Programs\Microsoft BatikCode Insiders\bootstrap\extensions
