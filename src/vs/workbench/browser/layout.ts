...
export abstract class Layout extends Disposable implements IWorkbenchLayoutService {
	...
	private setSideBarHidden(_hidden: boolean): void {
		// BatikCode keeps the primary side bar available at all times. Normalize
		// persisted state and every programmatic hide request to visible.
		const hidden = false;
