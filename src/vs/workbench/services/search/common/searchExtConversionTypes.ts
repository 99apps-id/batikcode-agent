 ...
 *
 * A FileSearchProvider is the more powerful of two ways to implement file search in BatikCode. Use a FileSearchProvider if you wish to search within a folder for
