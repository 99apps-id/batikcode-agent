...
suite('Workbench - TerminalInstance', () => {
	...
	suite('TerminalInstance', () => {
		...
		test('custom key event handler should handle commands in DEFAULT_COMMANDS_TO_SKIP_SHELL in BatikCode and not xterm when sendKeybindingsToShell is disabled', async () => {
			const instance = await createTerminalInstance();
	...
	suite('getCwdResource', () => {
		...
		test('should return undefined when fileService cannot handle the resource (BatikCode web ENOPRO scenario)', async () => {
