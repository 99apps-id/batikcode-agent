 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in BatikCode UI).
 */
 ...
 * to represent terminals that appear in other parts of the BatikCode UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their BatikCode OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given BatikCode log level.
	 */
	updateLogLevel(): void;
