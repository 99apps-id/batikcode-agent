 ...
 * - `IN_PRODUCT` - Content shown in BatikCode (both Stable and Insiders)
 * - `WEB` - Content shown on the website only
 * - `STABLE` - Content shown in BatikCode Stable only
 * - `INSIDERS` - Content shown in BatikCode Insiders only
 *
