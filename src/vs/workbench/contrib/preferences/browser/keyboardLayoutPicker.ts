...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in BatikCode in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open BatikCode and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
