...
type ScreenshotCapturedClassification = {
	...
	// Conversion factors
	windowZoomFactor: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'BatikCode per-window zoom factor for the hosting window (undefined if no editor currently holds the browser view).' };
	...
	// Window metadata
	windowInnerWidth: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Inner width of the hosting BatikCode window viewport, in workbench CSS pixels (window.innerWidth). Undefined if no editor currently holds the browser view.' };
	windowInnerHeight: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Inner height of the hosting BatikCode window viewport, in workbench CSS pixels (window.innerHeight). Undefined if no editor currently holds the browser view.' };
	isInAuxiliaryWindow: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Whether the browser view was hosted in a BatikCode auxiliary window at capture time (undefined if no editor currently holds the browser view).' };
	...
	// Screen metadata
	screenWidth: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Width of the screen the hosting BatikCode window is on, in OS-level CSS pixels (window.screen.width, unaffected by windowZoomFactor). Undefined if no editor currently holds the browser view.' };
	screenHeight: { classification: 'SystemMetaData'; purpose: 'FeatureInsight'; isMeasurement: true; comment: 'Height of the screen the hosting BatikCode window is on, in OS-level CSS pixels (window.screen.height, unaffected by windowZoomFactor). Undefined if no editor currently holds the browser view.' };
