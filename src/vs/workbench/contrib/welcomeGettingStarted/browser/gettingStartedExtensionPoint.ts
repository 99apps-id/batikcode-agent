							...
							completionEvents: {
								...
								items: {
									...
									defaultSnippets: [
										{
											label: 'onCommand',
											description: localize('walkthroughs.steps.completionEvents.onCommand.batikCode', 'Check off the step when a given command is executed anywhere in BatikCode.'),
