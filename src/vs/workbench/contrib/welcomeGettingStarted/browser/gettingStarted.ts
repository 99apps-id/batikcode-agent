...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const header = $('.header', {},
			...
			$('p.subtitle.description', {}, localize({ key: 'gettingStarted.batikCodeTagline', comment: ['Shown as subtitle on the BatikCode Welcome page.'] }, "Code with craft. Build with intelligence."))
		);
	...
	private buildTelemetryFooter(parent: HTMLElement) {
		...
		const text = localize({ key: 'footer.batikCode', comment: ['First substitution is the product name, second is "privacy statement", third is "opt out".'] },
