 ...
 * token-usage sidecar files. Kept separate from BatikCode's other user-data
 ...
 * token metrics survive a BatikCode restart (the reduced chat state keeps only the
 ...
 * stable, client-local per-session sidecar so token metrics survive a BatikCode
