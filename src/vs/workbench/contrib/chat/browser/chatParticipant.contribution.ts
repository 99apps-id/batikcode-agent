	...
	jsonSchema: {
		...
		items: {
			...
			properties: {
				...
				isDefault: {
					markdownDescription: localize('chatParticipantIsDefault', "PROPOSED API: Whether this is the default chat participant."),
					type: 'boolean'
				},
				locations: {
					markdownDescription: localize('chatParticipantLocations', "PROPOSED API: Locations where this chat participant is available."),
					type: 'array',
					items: {
						type: 'string',
				...
				modes: {
					markdownDescription: localize('chatParticipantModes', "PROPOSED API: Modes this chat participant supports."),
					type: 'array',
					items: {
						type: 'string',
						enum: ['agent', 'ask', 'edit']
