...
/**
 * Builds a redirect URL that GitHub will use to return the user to BatikCode
 ...
 * @param urlProtocol The BatikCode URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).
