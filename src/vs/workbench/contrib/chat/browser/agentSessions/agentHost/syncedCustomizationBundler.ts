...
const DISPLAY_NAME = 'BatikCode Synced Data';

const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from BatikCode',
}, null, '\t');
...
/**
 * An MCP server configured directly in BatikCode (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in BatikCode
