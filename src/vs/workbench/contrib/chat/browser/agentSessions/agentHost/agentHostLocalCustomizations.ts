 ...
 * instructions, and agents available as the local BatikCode client.
 *
 ...
 * and in the regular BatikCode workbench window it returns nothing at all.
 */
 ...
 * any per-provider plumbing. In the regular BatikCode workbench window the
...
/**
 * Enumerates MCP servers configured directly in BatikCode — i.e. those that
 ...
 * BatikCode — are bundled into a synthetic Open Plugin.
 */
