...
export class ChatMcpAppModel extends Disposable {
	 ...
	 * BatikCode restarts — using {@link WebviewOriginStore} for them would
		...
		try {
			...
			switch (request.method) {
				...
				case 'ui/request-display-mode':
					// BatikCode only supports inline display mode
	 ...
	 * server-definition id is stable across BatikCode restarts. Agent-host
