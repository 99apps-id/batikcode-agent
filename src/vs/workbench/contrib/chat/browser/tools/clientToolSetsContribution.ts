...
export class ClientToolSetsContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		this._register(this._registerDynamicToolSet(toolsService, {
			...
			icon: Codicon.vscode,
			description: localize('clientToolSet.vscode.description', "BatikCode"),
			detail: localize('clientToolSet.vscode.detail', "Navigate code, manage extensions, and run built-in BatikCode commands."),
			members: [
				'runTests',
				'testFailure',
				'rename',
