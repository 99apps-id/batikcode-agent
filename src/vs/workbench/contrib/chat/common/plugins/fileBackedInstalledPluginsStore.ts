 ...
 * BatikCode internal URI representations. The optional `name` identifies the
 * marketplace plugin and lets BatikCode re-read the full descriptor from the
 ...
 * other editors, etc.) without depending on BatikCode internals.
 *
