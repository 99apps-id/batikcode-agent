 ...
 *
 * The default (core) registration exposes a single "BatikCode" harness
...
export interface ICustomizationHarnessService {
	 ...
	 * BatikCode harness falls back to the core prompts service.
	 *
	 ...
	 * Provider-backed harnesses resolve their own items directly; the default BatikCode harness falls back to the core prompts service.
	 *
	 * @param sessionResource URI of the chat session whose customizations
...
/**
 * Creates a "BatikCode" harness descriptor that shows all storage sources
