...
export class PromptsService extends Disposable implements IPromptsService {
	 ...
	 * The number in the returned tuple is textModel.getVersionId(), which is an internal BatikCode counter that increments every time the text model's content changes.
	 */
