...
/**
 * Allows webviews to monitor when an element in the BatikCode editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. BatikCode needs to see this
