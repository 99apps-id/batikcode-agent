# BatikCode Long-Term Memory

## Product direction

- BatikCode is being reset onto Code - OSS, not rebuilt as a custom approximation of VS Code.
...
- Microsoft trademarks, Marketplace entitlement, update services, telemetry, voice services, and Copilot defaults are not part of the BatikCode distribution.
...
1. Original BatikCode branding and artwork.
...
4. Build BatikCode AI through generic chat/agent seams or a built-in provider extension.
