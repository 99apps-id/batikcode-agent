...
documents and `docs/adr/`.

The retired React/Electron prototype source, dependencies, and build output
were intentionally not retained after the Code - OSS migration.
