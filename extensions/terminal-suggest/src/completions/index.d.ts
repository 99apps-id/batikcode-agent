...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- BatikCode edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- BatikCode edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- BatikCode edit to make results correct
		/**
		 *
