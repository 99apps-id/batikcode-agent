...
The Monaco Editor is the fully featured code editor from [BatikCode](https://github.com/microsoft/vscode). Check out the [BatikCode docs](https://code.visualstudio.com/docs/editor/editingevolved) to see some of the supported features.
...
Monaco editor is best known for being the text editor that powers BatikCode. However, it's a bit more nuanced. Some basic understanding about the underlying concepts is needed to use Monaco editor effectively.
...
❓ **What is the relationship between BatikCode and the Monaco Editor?**

The Monaco Editor is generated straight from BatikCode's sources with some shims around services the code needs to make it run in a web browser outside of its home.

❓ **What is the relationship between BatikCode's version and the Monaco Editor's version?**

None. The Monaco Editor is a library and it reflects directly the source code.

❓ **I've written an extension for BatikCode, will it work on the Monaco Editor in a browser?**
...
It is an AMD loader that we use in BatikCode. Yes.
