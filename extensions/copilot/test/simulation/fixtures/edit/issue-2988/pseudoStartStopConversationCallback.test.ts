...
suite('Post Report Conversation Callback', () => {
	...
	test('Start word without a stop word', () => {
		...
		testObj.apply('', { text: `I'm sorry, but as an AI programming assistant, I'm here to provide assistance with software development topics, specifically related to BatikCode. I'm not equipped to provide a definition of a computer. [RESPONSE END]` });

		assert.strictEqual((progress[0] as ChatAgentContent).content, `I'm sorry, but as an AI programming assistant, I'm here to provide assistance with software development topics, specifically related to BatikCode. I'm not equipped to provide a definition of a computer. [RESPONSE END]`);
	});
