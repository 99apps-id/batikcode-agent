...
/**
 * The Codicon library is a set of default icons that are built-in in BatikCode.
 *
 * In the product (outside of base) Codicons should only be used as defaults. In order to have all icons in BatikCode
