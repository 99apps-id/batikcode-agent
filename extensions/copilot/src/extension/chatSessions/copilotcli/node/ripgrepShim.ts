...
/**
 * Copies the ripgrep files from BatikCode's installation into a @github/copilot location
 *
 ...
 * @param vscodeAppRoot BatikCode's installation path (where ripgrep is located)
 */
