...
/** The user-facing display label of an MCP server (from BatikCode settings). */
 ...
 * to BatikCode MCP server display labels.
 */
 ...
 * to BatikCode MCP server labels.
 *
 ...
 * @param mcpServerMappings Maps friendly server names (from agent files) → BatikCode MCP display labels.
