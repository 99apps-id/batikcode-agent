...
/**
 * Roots under BatikCode's app root that may hold its bundled `node_modules`, in
 * priority order.
 *
 ...
 * `node_modules`. Consumers that reach into BatikCode's own modules for native
...
/**
 * Resolves a path to one of BatikCode's bundled module resources, checking both
