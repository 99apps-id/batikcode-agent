...
## Configuration
To configure the MCP server for use with Visual Studio or BatikCode, use the following snippet and include it in your `mcp.json`:
...
| BatikCode | [MCP configuration in BatikCode](https://code.visualstudio.com/docs/copilot/chat/mcp-servers#_add-an-mcp-server) |
