### Developing
Prior to beginning these steps, please make sure you are running the latest version of BatikCode Insiders.
- Follow the steps [here](../../../CONTRIBUTING.md#first-time-setup)
    - You may need to run `npm run compile` as well
- Add the following to your BatikCode `settings.json` (File -> Preferences -> Settings):
    ```
