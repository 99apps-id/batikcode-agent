...
/**
 * Handles partial acceptance for BatikCode clients using line-based strategy.
 * BatikCode tracks acceptance by lines and resets the accepted length per line.
 */
 ...
 * This method is primarily used by BatikCode for explicit full acceptances.
 */
