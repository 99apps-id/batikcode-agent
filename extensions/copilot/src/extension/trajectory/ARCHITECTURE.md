...
This document explains the architecture of trajectory logging in BatikCode Copilot Chat, 
...
│  2. token.chatSessionId         │  BatikCode chat session ID     │
│  3. generateSessionId(label)    │  Fallback: hash + timestamp  │
└─────────────────────────────────────────────────────────────────┘
```

This enables:
- **Main trajectories**: Use BatikCode's chat session ID for 1:1 mapping
