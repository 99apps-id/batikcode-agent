 ...
 * be non-deferred. These are core tools provided by BatikCode or dynamically
 * injected tools.
 */
const additionalNonDeferredToolNames = new Set<string>([
	// Core tools provided by BatikCode (not registered via ToolRegistry.registerTool)
	...
	'task_complete',
	// BatikCode built-in language tools that should always be available
	'vscode_renameSymbol',
