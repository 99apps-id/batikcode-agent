 ...
 * This simulates the EOL sequence behavior of BatikCode, namely it keeps the EOL sequence
...
export class WorkingCopyOriginalDocument {
	...
	constructor(
		...
		// BatikCode doesn't allow mixed EOL sequences, so the presence of one \r\n
