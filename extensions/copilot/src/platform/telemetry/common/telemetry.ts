...
export interface IGHTelemetryService {
	...
	/**
	 * Standard telemetry events can be disabled with BatikCode's telemetry settings.
	 */
	...
	/**
	 * Enhanced telemetry events contain additional data such as user prompts and suggestions. Like standard telemetry events, it can disabled with BatikCode's telemetry settings or the Copilot settings page.
	 *
