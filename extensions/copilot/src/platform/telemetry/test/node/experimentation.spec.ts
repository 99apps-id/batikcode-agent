...
describe('ExP Service Tests', () => {
	...
	it('should detect BatikCode team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as BatikCode team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should detect non-BatikCode team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as non BatikCode team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should persist BatikCode team member status to global state', async () => {
		await expService.hasTreatments();
	...
	it('should use cached BatikCode team member status on initialization', async () => {
	...
	it('should trigger treatment refresh when BatikCode team membership changes', async () => {
		await expService.hasTreatments();
		...
		// Sign in as BatikCode team member - this will trigger a user info change (from undefined to a value)
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
		copilotTokenService.copilotToken = VscodeTeamMemberToken;
		await treatmentsChangePromise;
