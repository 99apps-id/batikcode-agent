...
export const CopilotChatAttr = {
	...
	/** BatikCode chat session ID from CapturingToken — the definitive session identifier */
...
/**
 * Tool names treated as file tools for parameter extraction. Covers BatikCode's
...
export const FILE_TOOL_NAMES: ReadonlySet<string> = new Set([
	...
	'replaceString',
	'applyPatch',
	// BatikCode tool names (ToolName enum)
	'read_file',
	'create_file',
	'apply_patch',
