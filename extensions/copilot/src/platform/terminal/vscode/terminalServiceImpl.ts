...
export class TerminalServiceImpl extends Disposable implements ITerminalService {
	...
	// BatikCode will apply them in order from its own cache.
	// So when re-loading BatikCode vscode first applies it from its cache, then we apply our contributions.
