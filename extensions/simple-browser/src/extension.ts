...
const batikCodePreviewCommand = 'batikcode.browserPreview.open';
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand(showCommand, openPreview),
		vscode.commands.registerCommand(batikCodePreviewCommand, openPreview)
	);
