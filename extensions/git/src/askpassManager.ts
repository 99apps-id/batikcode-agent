 ...
 * like GIT_ASKPASS point to scripts inside the BatikCode installation directory, which
...
/**
 * Checks if the current BatikCode installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when BatikCode updates.
 */
