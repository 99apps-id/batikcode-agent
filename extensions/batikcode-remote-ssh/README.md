# BatikCode Remote SSH

![Open Remote SSH](https://raw.githubusercontent.com/batikcode/batikcode-remote-ssh/master/docs/images/batikcode-remote-ssh.gif)
...
```json
{
    ...
    "enable-proposed-api": [
        ...,
        "batikcode.batikcode-remote-ssh",
    ]
    ...
}
```
